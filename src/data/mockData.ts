import { Exercise, GymClass, Student, Workout, Measurement } from './types';
...
export const mockWorkouts: Workout[] = [
  {
    id: '1', name: 'Treino A - Peito e Triceps', day: 'Segunda',
    exercises: [
  ...
  {
    id: '2', name: 'Treino B - Pernas', day: 'Terca',
    exercises: [
  ...
  {
    id: '3', name: 'Treino C - Costas e Biceps', day: 'Quarta',
    exercises: [
...
export const mockClasses: GymClass[] = [
  ...
  { id: '2', name: 'Musculacao Guiada', instructor: 'Ana Santos', day: 'Terca', time: '09:00', duration: 60, capacity: 15, enrolled: 12, description: 'Treino de musculacao supervisionado por personal.' },
  { id: '3', name: 'Zumba', instructor: 'Maria Oliveira', day: 'Quarta', time: '18:00', duration: 50, capacity: 40, enrolled: 35, description: 'Danca fitness com ritmos latinos.' },
...
export const mockStudents: Student[] = [
  { id: '1', name: 'Joao Silva', email: 'joao@email.com', phone: '(11) 99999-1111', plan: 'premium', planStartDate: '2024-01-01', planEndDate: '2025-01-01', status: 'ativo' },
